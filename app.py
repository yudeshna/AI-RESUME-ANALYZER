...
if st.session_state.user is None and st.session_state.page in ["login", "intro"]:
...
if st.session_state.page == "intro":
    ...
    .intro-wrap {
        ...
        background: radial-gradient(ellipse at 50% 40%, #0d1f3a 0%, #060b14 70%);
        z-index: 9999;
        overflow: hidden;
    }
    ...
    .stars {
        ...
        background-image:
            ...
            radial-gradient(1px 1px at 70% 15%, #ffffff44, transparent),
            radial-gradient(1px 1px at 85% 75%, #ffffff33, transparent),
            radial-gradient(1px 1px at 50% 45%, #ffffff22, transparent),
            radial-gradient(1px 1px at 20% 85%, #ffffff33, transparent),
    ...
    .intro-title {
        ...
        animation: shimmer 2s linear infinite, fadeInUp 0.8s ease 0.5s both;
        text-align: center;
    ...
    .resume-card {
        ...
        background: linear-gradient(135deg, #1a2a4a, #0d1f3a);
    ...
    .loading-bar-fill {
        ...
        border-radius: 99px;
        background: linear-gradient(90deg, #00d4ff, #7b2ff7);
        animation: loadFill 2.8s cubic-bezier(0.4,0,0.2,1) 0.5s forwards;
        width: 0%;
    }
    ...
    <div class="intro-wrap">
        ...
        <!-- Airplane orbiting with resume -->
        <div class="plane-orbit">
            <div class="plane">✈️</div>
            <div class="resume-card">
                <div class="resume-line" style="width:32px;"></div>
                <div class="resume-line" style="width:24px;opacity:0.7;"></div>
                <div class="resume-line" style="width:28px;opacity:0.5;"></div>
                <div class="resume-line" style="width:20px;opacity:0.4;"></div>
                <div class="resume-line" style="width:30px;opacity:0.6;"></div>
            </div>
        </div>

        <!-- Title -->
        <div class="intro-title">AI Resume Analyzer Pro</div>
        <div class="intro-sub">Your Career · Supercharged by AI</div>
        ...
        <div class="loading-bar-wrap">
            ...
            <div class="loading-text">LAUNCHING YOUR CAREER DASHBOARD...</div>
        </div>
    </div>
    ...
    # Auto advance to login after 3.5 seconds using Streamlit
